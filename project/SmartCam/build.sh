...
BOARD_LIST=("imx8m" "t507","t113","rk3576","rk3576_ubuntu")
...
ROOTFS_LIST=(
    ...
    [t113]="/opt/toolchain/t113-i/arm-buildroot-linux-gnueabihf_sdk-buildroot/arm-buildroot-linux-gnueabihf/sysroot"
    [rk3576]="/opt/toolchain/rk3576/aarch64-buildroot-linux-gnu_sdk-buildroot/aarch64-buildroot-linux-gnu/sysroot/"
    [rk3576_ubuntu]="/opt/toolchain/rk3576/rk3576_ubuntu/aarch64-buildroot-linux-gnu/sysroot"
)
...
CROSSCOMPILE_TOOLCHAIN_LIST=(
    ...
    [t113]="${PROJECT_DIR}/toolchain/CrossCompile_t113.cmake"
    [rk3576]="${PROJECT_DIR}/toolchain/CrossCompile_rk3576.cmake"
    [rk3576_ubuntu]="${PROJECT_DIR}/toolchain/CrossCompile_rk3576_ubuntu.cmake"
)
