...
extern int func_eth0_test_main(const char *case_name,unsigned loop_count,int argc,char *argv[]);
extern int func_eth1_test_main(const char *case_name,unsigned loop_count,int argc,char *argv[]);
extern int func_led_test_main(const char *case_name,unsigned loop_count,int argc,char *argv[]);
extern int func_rs422_test_main(const char *case_name,unsigned loop_count,int argc,char *argv[]);
extern int func_can_test_main(const char *case_name,unsigned loop_count,int argc,char *argv[]);
extern int func_ssi_test_main(const char *case_name,unsigned loop_count,int argc,char *argv[]);
extern int func_rtc_test_main(const char *case_name,unsigned loop_count,int argc,char *argv[]);
...
static struct elec_test g_elec_test[MODULE_MAX_NUM] = {
    ...
    {
        .module_name = "rs422",
        .module_process = func_rs422_test_main,
    },
    {
        .module_name = "eth0",
        .module_process = func_eth0_test_main,       
    },
    {
        .module_name = "eth1",
        .module_process = func_eth1_test_main,       
    },
    {
        .module_name = "can",
        .module_process = func_can_test_main,       
    },
    {
        .module_name = "ssi",
        .module_process = func_ssi_test_main,       
    },
    {
        .module_name = "rtc",
        .module_process = func_rtc_test_main,       
    }                
};
